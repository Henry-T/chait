...
namespace ChaitAppProtocol
{
    public class CProtocol
    {
        ...
        // 3 用户可以选择自由组中的用户进行私聊
        // 4 随时获取所有在线用户列表
        // 5 用户权限分配和管理  - 如：已连接但是未提交昵称的用户只能够进行提交昵称操作
        #endregion
        ...
        // 群组
        public const int JoinGroup = 31;       // 加入/创建群组   服务器     JoinGroup    GroupName
        public const int QuitGroup = 32;       // 退出群组        服务器     QuitGroup    GroupName
        public const int GroupList = 34;       // 获取群组列表    服务器
        public const int Yell = 33;            // 群组内呼喊      服务器     Yell         GroupLength GroupName YellString

        // 文件
        public const int FileRequest = 61;     // 文件发送请求    服务器     FileRequest  NeckLength RecieverNeck SafeFileName
        public const int FileAccept = 62;      // 文件接收方接受  服务器     FileAccept   NeckLength SenderNeck SafeFileName -- [S->C]: FileAccept NeckLength NeckName FileNameLength SafeFileName IPAddr
        public const int FileRefuse = 63;      // 文件接收方拒绝  服务器     FileRefuse   NeckLength SenderName SafeFileName
        public const int FilePause = 64;       // 文件传递暂停    服务器     FilePause    NeckLength NeckName SaveFileName
        public const int FileResume = 65;      // 文件传递继续    服务器     FileResume   NeckLength NeckName SaveFileName
        ...
        // 玩家控制
        public const int SetTarget = 81;        // 发送角色移动命令 服务器    SetTarget    NeckLength NeckName PosX PosY
        ...
        // 群组
        //public const int JoinGroup = 31;       // 加入群组        群组/特例  JoinGroup    NeckLength NeckName GroupName
        //public const int QuitGroup = 32;       // 退出群组        群组/特例  QuitGroup    NeckLength NeckName GroupName
        //public const int GroupList = 34;       // 获取群组列表    单一       GroupList    GroupNum GroupLen1 GroupName1 GroupLen2 GroupName2 ...
        //public const int Yell = 33;            // 群组内呼喊      群组       Yell         NeckLength NeckName GroupLength GroupName YellString

        // 文件
        //public const int FileRequest = 61;     // 文件发送请求    单一       FileRequest  NeckLength SenderName SafeFileName
        //public const int FileAccept = 62;      // 文件接收方接受  单一       FileAccept   NeckLength RecieverNeck FileNameLength SafeFileName IPAddr
        //public const int FileRefuse = 63;      // 文件接收方拒绝  单一       FileRefuse   NeckLength RecieverNeck SafeFileName
        //public const int FilePause = 64;       // 文件传递暂停    单一       FilePause  NeckLength NeckName SaveFileName
        //public const int FileResume = 65;      // 文件传递继续    单一       FileResume NeckLength NeckName SaveFileName
        ...
        // 角色更新
        public const int RolePos = 91;         // 角色位置更新      RolePos   NeckLength NeckName PosX PosY       // * 暂时使用TCP
